export const projects = [
  {
    ...
    description:
      "Designed an intuitive online art platform that simplifies browsing and purchasing artworks, combining aesthetics with usability and accessibility.",
    image: "/images/Artella.png",
    link: "/project/artella",
  },
  {
    id: 2,
