...
export default function ContactPage() {
  return (
    <main className="bg-white text-[#1A1A1A] min-h-screen flex flex-col items-center justify-center px-6 md:px-16 py-20">
      ...
      {/* email link*/}
      <a
        href="mailto:smr82computer@gmail.com?subject=Portfolio%20Inquiry&body=Hi%20Samaneh,%0D%0A%0D%0AI%20visited%20your%20portfolio%20and%20would%20like%20to%20connect."
